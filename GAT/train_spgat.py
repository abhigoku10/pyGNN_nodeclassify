...
def main():
    ...
    parser = argparse.ArgumentParser(description="SP-GAT GNN Node Classification ")
    parser.add_argument('--config_path', action='store_true', \
    default='E:\\Freelance_projects\\GNN\\Tutsv2\\pyGNN_NC_XAI_V2\\GAT\\config\\spgat_pubmed.yaml', help='Provide the config path')
